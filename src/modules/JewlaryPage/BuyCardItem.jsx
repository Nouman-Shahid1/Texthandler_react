...
const BuyCarditem = ({ title, imageSrc, price, description, onAddToCart }) => {
  const handleAddToCart = () => {
    onAddToCart({ title, imageSrc, price });
  };
  ...
  return (
    ...
    <div className="flex flex-wrap justify-between items-center">
      ...
      <button className="bg-black text-white px-4 py-2 rounded-md hover:bg-gray-900 transition duration-300">
        Buy Now
                  </button>
